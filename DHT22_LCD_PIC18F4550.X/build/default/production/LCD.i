...
if (dato & (1<<4)) LATDbits.LATD4 = 1; else LATDbits.LATD4 = 0;
if (dato & (1<<5)) LATDbits.LATD5 = 1; else LATDbits.LATD5 = 0;
if (dato & (1<<6)) LATDbits.LATD6 = 1; else LATDbits.LATD6 = 0;
if (dato & (1<<7)) LATDbits.LATD7 = 1; else LATDbits.LATD7 = 0;
LATDbits.LATD2 = 1;
__nop();
LATDbits.LATD2 = 0;
